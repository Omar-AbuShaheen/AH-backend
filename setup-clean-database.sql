...
CREATE TABLE applications (
    ...
    status VARCHAR(50) DEFAULT 'Applied' CHECK (status IN ('Applied', 'Shortlisted', 'Hired', 'Rejected', 'Withdrawn')),
    cover_letter TEXT,
...
(2, 'Frontend Developer Intern', 'Join our team to build amazing web applications', 'React, JavaScript, HTML, CSS', 'Develop user interfaces, collaborate with team members', '3 months', 'New York', 'Full-time', '$2000/month', '$2000/month', '2024-12-31', true);

-- Insert sample application
INSERT INTO applications (student_id, internship_id, status, cover_letter) VALUES 
(3, 1, 'Applied', 'I am excited to apply for this position and believe my skills and experience make me a great candidate...');
